...
df = pd.read_excel(r'src/Archivo_de_ingenieria.xlsx', sheet_name="Porcentaje")
df_calificaciones = pd.read_excel(r'src/Archivo_de_ingenieria.xlsx', sheet_name="Calificaciones")
df_totales = pd.read_excel(r'src/Archivo_de_ingenieria.xlsx', sheet_name="Totales")
df_pie = pd.read_excel(r'src/Archivo_de_ingenieria.xlsx', sheet_name="Datos")

#segundos datos
df_TE =pd.read_excel(r'src/Archivo_de_TIC.xlsx', sheet_name= "Porcentaje de TIC")
df_calificaciones_TE = pd.read_excel(r'src/Archivo_de_TIC.xlsx', sheet_name= "Calificaciones de TIC")
df_totales_TE = pd.read_excel(r'src/Archivo_de_TIC.xlsx', sheet_name= "Totales de TIC")
df_pie_TE = pd.read_excel(r'src/Archivo_de_TIC.xlsx', sheet_name="Datos_TIC")
...
html.Div([
  ...
  dbc.Card(
    ...
    [  # 5
        ...
        dbc.CardBody([
            html.P(f"{df_totales['promedio de porcentaje'].iloc[0]:,.2f}",
                   style={
                       'textAlign': 'center',
                       'color': 'orange',
                       'fontSize': 40}
...
html.Div([
  ...
  dbc.Card(
    ...
    [  # 5
        ...
        dbc.CardBody([
            html.P(f"{df_totales_TE['promedio de porcentaje'].iloc[0]:,.2f}",
                   style={
                       'textAlign': 'center',
                       'color': 'orange',
                       'fontSize': 40}
...
def update_graph(relayout_data):
    # Crea la gráfica lineal usando Plotly Express
    fig = px.line(combined_df,x = 'Nombres', y='porcentajes', color='Tipo', markers=True,
                  labels={'porcentajes': 'porcentajes', 'Nombres': 'Nombre del Alumno'},
                  title='Gráfica de Porcentajes para Ingeniería y Licenciatura', 
                  category_orders={'Nombres': category_order})
